...
export default function MainFooter() {
  ...
  return (
    <footer className="dark">
      ...
      <div className="bar">
        <div className="links">
          <a href="/downloads" onClick={() => gtmConanPush("downloads")}>Downloads</a>
          <a href="/center" onClick={() => gtmConanPush("conancenter")}>ConanCenter</a>
          <a href="https://github.com/conan-io/conan" target="_blank" rel="noopener noreferrer" onClick={() => gtmConanPush("github")}>GitHub</a>
          <a href="https://docs.conan.io/" target="_blank" rel="noopener noreferrer" onClick={() => gtmConanPush("docs")}>Docs</a>
