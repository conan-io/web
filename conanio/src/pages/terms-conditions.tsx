      ...
      <main id="page" className={styles.termsPage} data-screen-label="Conan Terms and Conditions">
        ...
        <div className="doc-wrap">
          ...
          <article className="doc" id="terms-and-conditions">
            ...
            <h2 id="ip">Intelectual Property</h2>
            <p>
              We claim no intellectual property rights over the content you upload to the Website. Your profile and content uploaded remain yours. However, by using the FREE mode for your contents, you agree to allow others to view your Content. By setting your contents to be viewed publicly, you agree to allow others to view and copy your contents. The user may include with their contents in a prominent and clearly visible manner, a license explaining the main limitations or conditions of use of the content, that other users must comply with. In the event that the User does not indicate any license, default copyright laws apply, stating that the User holds all rights over the uploaded contents. However, please notice that by uploading contents to Conan you expressly grant Conan the right of distribution, reproduction and public communication of the contents, as established in the Intellectual Property Act (Minimum Required License) as this license is needed by Conan&apos;s platform to render its services to other users. This Minimum Required License is granted universally and for free. Please notice that Conan just needs this license to operate the platform but no further rights are granted to Conan or other users. You should ensure when storing content in the platform of Conan that you are not infringing rights of intellectual property, or any other similar rights on the content that you store in Conan. In particular, you should ensure Conan and other users of the platform that the storage and the use of the content that you store, whether developed by you or by third parties, does not violate applicable law or the rights of others. Please notice that you are required to indemnify Conan and the remaining users against any third party claim arising from the violation of their rights of intellectual property or industrial, or any similar legal position of economic content, by (i) the use or exploitation of contents in accordance with its limitations of use, (ii) the use or exploitation of contents in accordance with these Terms and Conditions of Use, or (iii) the use you give to the service that breach these Terms and Conditions of Use. Also remember that you are responsible for checking if the code you intend to use includes conditions or limitations of use and, if any, you are responsible to respect them.
            </p>
            <h2 id="copyright">Copyright</h2>
            <p>
              Except for material in the public domain under copyright law, all material contained on the Web site (including all software, HTML code, Java applets, Active X controls and other code) is protected by copyright laws. Except as otherwise expressly provided in these terms and conditions, you may not copy, distribute, transmit, display, perform, reproduce, publish, license, modify, rewrite, create derivative works from, transfer, or sell any material contained on the Web site without the prior consent of the copyright owner. None of the material contained on Conan.io Website may be reverse-engineered, disassembled, decompiled, transcribed, stored in a retrieval system, translated into any language or computer language, retransmitted in any form or by any means (electronic, mechanical, photo reproduction, recordation or otherwise), resold or redistributed without the prior written consent of Conan.io Website. Violation of this provision may result in severe civil and criminal penalties. The look and feel of the Service is copyright ©2018 JFrog. All rights reserved. You may not duplicate, copy, or reuse any portion of the HTML/CSS, Javascript, or visual design elements or concepts without express written permission from Conan
            </p>
            <div className="doc-footnote">
              <b>Questions?</b> If you have any questions about these Terms and Conditions, please use the Conan community channels linked in the footer below.
            </div>
          </article>
        </div>
        <MainFooter />
