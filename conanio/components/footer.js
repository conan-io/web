            ...
            <section id="signUp" className="sign-up white text-center">
              ...
              <div className="mktoFormWrapper">
                ...
                <div className="d-flex justify-content-center pt-3">
                  <form id="mktoForm_1479" className="text-center" style={{width: '100%'}}></form>
                </div>
              </div>
            </section>
          </div>
        ...
        <div className="row d-flex justify-content-center px-0 px-md-3" style={{borderTop: '1px solid #404040',textAlign: 'center'}}>
          <div className="col-md-10 px-md-0 pl-3 pt-2">
            <ul className="d-md-flex justify-content-start pt-2 mt-1 list-unstyled footer-links">
              <li>
                <Link href="downloads.html"><a id="downloads_btn_footer">Download</a></Link>
              </li>
              <li>
                <Link href="https://conan.io/center/"><a id="conancenter_btn_footer">ConanCenter</a></Link>
              </li>
              <li>
                <Link href="https://github.com/conan-io/conan"><a id="github_btn_footer">GitHub</a></Link>
              </li>
              <li>
                <Link href="https://docs.conan.io/"><a id="docs_btn_footer">Docs</a></Link>
              </li>
              <li>
                <Link href="https://blog.conan.io/"><a id="blog_btn_footer">Blog</a></Link>
              </li>
              <li>
                <Link href="/faq"><a id="faq_btn_footer">FAQ</a></Link>
              </li>
              <li>
                <Link href="/privacy-policy"><a id="privacypolicy_btn_footer">Privacy Policy</a></Link>
              </li>
              <li>
                <Link href="/terms-conditions"><a id="terms_btn_footer">Terms</a></Link>
              </li>
              <li>
                <Link href="#"><a className="ot-sdk-show-settings" id="cookies_btn_footer">Cookies Settings</a></Link>
              </li>
            </ul>
          </div>
