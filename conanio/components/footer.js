              ...
              <div className="row">
                ...
                <div className="col-sm-3">
                  <h4 className="blue mb-1">Social</h4>
                    <div><a href="https://github.com/conan-io" rel="noopener noreferrer" taget="_blank">Github </a></div>
                    <div><a href="https://twitter.com/conan_io" rel="noopener noreferrer" taget="_blank">Twitter </a></div>
                    <div><a href="https://facebook.com/conan.io" rel="noopener noreferrer" taget="_blank">Facebook </a></div>
                    <div><a href="https://cpplang.​slack.​com/?id=conan" rel="noopener noreferrer" taget="_blank">Slack #conan </a></div>
                </div>
              </div>
            </div>
          </div>
